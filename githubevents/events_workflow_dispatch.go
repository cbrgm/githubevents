...
// 2) All callbacks registered by OnWorkflowDispatchEventAny are executed in parallel.
// 3) Optional: All callbacks registered via OnWorkflowDispatchEvent... are executed in parallel in case the Event has actions.
