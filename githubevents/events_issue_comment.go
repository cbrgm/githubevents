...
// 2) All callbacks registered with OnIssueCommentEventAny are executed in parallel.
// 3) Optional: All callbacks registered with OnIssueCommentEvent... are executed in parallel in case the Event has actions.
