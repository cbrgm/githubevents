...
// 2) All callbacks registered with OnProjectColumnEventAny are executed in parallel.
// 3) Optional: All callbacks registered with OnProjectColumnEvent... are executed in parallel in case the Event has actions.
