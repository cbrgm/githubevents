...
// 2) All callbacks registered by OnWorkflowJobEventAny are executed in parallel.
// 3) Optional: All callbacks registered via OnWorkflowJobEvent... are executed in parallel in case the Event has actions.
