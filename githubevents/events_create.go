...
// 2) All callbacks registered with OnCreateEventAny are executed in parallel.
// 3) Optional: All callbacks registered with OnCreateEvent... are executed in parallel in case the Event has actions.
