...
// 2) All callbacks registered by OnOrganizationEventAny are executed in parallel.
// 3) Optional: All callbacks registered via OnOrganizationEvent... are executed in parallel in case the Event has actions.
