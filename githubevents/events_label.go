...
// 2) All callbacks registered by OnLabelEventAny are executed in parallel.
// 3) Optional: All callbacks registered via OnLabelEvent... are executed in parallel in case the Event has actions.
