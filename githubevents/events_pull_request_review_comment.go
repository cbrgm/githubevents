...
// 2) All callbacks registered by OnPullRequestReviewCommentEventAny are executed in parallel.
// 3) Optional: All callbacks registered via OnPullRequestReviewCommentEvent... are executed in parallel in case the Event has actions.
