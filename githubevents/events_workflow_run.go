...
// 2) All callbacks registered by OnWorkflowRunEventAny are executed in parallel.
// 3) Optional: All callbacks registered via OnWorkflowRunEvent... are executed in parallel in case the Event has actions.
