...
// 2) All callbacks registered by OnPullRequestReviewEventAny are executed in parallel.
// 3) Optional: All callbacks registered via OnPullRequestReviewEvent... are executed in parallel in case the Event has actions.
