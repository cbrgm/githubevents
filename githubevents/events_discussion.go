...
// 2) All callbacks registered by OnDiscussionEventAny are executed in parallel.
// 3) Optional: All callbacks registered via OnDiscussionEvent... are executed in parallel in case the Event has actions.
