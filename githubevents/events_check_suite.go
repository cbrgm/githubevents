...
// 2) All callbacks registered with OnCheckSuiteEventAny are executed in parallel.
// 3) Optional: All callbacks registered with OnCheckSuiteEvent... are executed in parallel in case the Event has actions.
