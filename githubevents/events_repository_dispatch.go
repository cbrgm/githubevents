...
// 2) All callbacks registered with OnRepositoryDispatchEventAny are executed in parallel.
// 3) Optional: All callbacks registered with OnRepositoryDispatchEvent... are executed in parallel in case the Event has actions.
