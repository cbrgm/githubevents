...
// 2) All callbacks registered by OnStatusEventAny are executed in parallel.
// 3) Optional: All callbacks registered via OnStatusEvent... are executed in parallel in case the Event has actions.
