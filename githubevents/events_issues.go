...
// 2) All callbacks registered by OnIssuesEventAny are executed in parallel.
// 3) Optional: All callbacks registered via OnIssuesEvent... are executed in parallel in case the Event has actions.
