...
// 2) All callbacks registered by OnGitHubAppAuthorizationEventAny are executed in parallel.
// 3) Optional: All callbacks registered via OnGitHubAppAuthorizationEvent... are executed in parallel in case the Event has actions.
