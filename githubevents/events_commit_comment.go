...
// 2) All callbacks registered by OnCommitCommentEventAny are executed in parallel.
// 3) Optional: All callbacks registered via OnCommitCommentEvent... are executed in parallel in case the Event has actions.
