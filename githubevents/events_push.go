...
// 2) All callbacks registered by OnPushEventAny are executed in parallel.
// 3) Optional: All callbacks registered via OnPushEvent... are executed in parallel in case the Event has actions.
