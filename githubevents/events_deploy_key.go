...
// 2) All callbacks registered by OnDeployKeyEventAny are executed in parallel.
// 3) Optional: All callbacks registered via OnDeployKeyEvent... are executed in parallel in case the Event has actions.
